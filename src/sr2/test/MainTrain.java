...
public class MainTrain {
    ...
    public static void testDictionary() {
        ...
        if(!d.query("is"))
            System.out.println("1problem with dictionarry in query (-5)");
        if(d.query("badong"))
            System.out.println("2problem with dictionarry in query (-5)");
        if(!d.challenge("lazy"))
            System.out.println("3problem with dictionarry in query (-5)");
        if(d.challenge("afass"))
            System.out.println("4problem with dictionarry in query (-5)");
    }
