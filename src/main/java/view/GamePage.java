...
public class GamePage extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        verticalCheckBox.setStyle("-fx-text-fill: white; -fx-font-size: 14px;");
        verticalCheckBox.setAlignment(Pos.BOTTOM_RIGHT);
        verticalCheckBox.setTranslateY(-4); // Move the CheckBox 10 pixels up

        // Button: Pass
        Button passButton = new Button("Pass");
        passButton.setStyle("-fx-background-color: #333333; -fx-text-fill: white; -fx-font-size: 14px;");
        ...
        challengeButton.setStyle("-fx-background-color: #333333; -fx-text-fill: white; -fx-font-size: 14px;");
        ...
        quitButton.setStyle("-fx-background-color: #333333; -fx-text-fill: white; -fx-font-size: 14px;");
        ...
        cellLabel.setOnDragDropped(event -> {
            ...
            if (db.hasString()) {
                ...
                if (cellLabel.getText().equals(tile)) {
                    ...
                    placedTiles.add(cellLabel.getText());
                    success = true;
                } else {
